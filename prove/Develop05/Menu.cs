...
private void RecordGoal()
{
    ...
    Console.WriteLine($"You now have {_totalPoints} points!");
           ...
           // if (choice == "1") _manager.CreateGoal();
        //else if (choice == "2") _manager.ListGoals();
           // else if (choice == "3") _manager.RecordEvent();
           // else if (choice == "4") _manager.SaveGoals();
           // else if (choice == "5") _manager.LoadGoals();
